  ...
  <div id="container">
    <div id="filter-result">
          ...
          <div>
            <div>
              <div class="ui action input fluid">
                ...
                <div @click="locatorButtonPressed" class="colored ui right-floated medium animated fade teal button">
            ...
            <div @click="findCloseBuyButtonPressed" class="colored ui right-floated medium animated fade secondary button">
              <div class="visible content">
      ...
      <div id="close-places-list" style="height:200px;
                ...
                display:none">
        <div class="place-list-row" v-for="place in places" :key="place.id" @click="showPlaceOnMap(place)">
          <div class="list-el">
            <div class="left">
