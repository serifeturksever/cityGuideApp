export const exported_places = [
    // * Tourist Attraction
    {
      id: "ChIJa5UWmPfYuxQRp-muszhGrU0",
      name:
        "İzmir Aziz Yuhanna Katolik Kilisesi - Merkez Katolik Kilise ve Bazilikası",
      description:
        "Aziz Yuhanna Katedrali veya Aziz Yuhanna Bazilikası, Türkiye'nin İzmir şehrinde yer 	alan bir Katolik katedralidir. İzmir Katolik Başpiskoposluğu'nun merkezidir. Adını on iki havariden biri olan Yuhanna'dan almaktadır. ",
    ...
    },
    {
      ...
      name:
        "T.C. Kültür ve Turizm Bakanlığı İzmir Tarih ve Sanat Müzesi/ Museum Of History And Art",
      description:
    ...
    },
    {
      ...
      description:
        "İzmir Agorası veya Smyrna Agorası, günümüzde İzmir'in Konak ilçesinde bulunan ve MÖ 4. yüzyılda kurulan agoradır. Zamanında kentin devlet agorası olarak işlev gördü. MS 178'de meydana gelen depremin ardından Roma İmparatoru Marcus Aurelius'un desteğiyle yeniden inşa edildi.",
    ...
    },
    {
      ...
      name: "Lunapark",
      description:
        "Dönen oyuncaklar, hız trenleri, dönme dolap ve çocuklara yönelik eğlenceleriyle küçük lunapark.",
    ...
    },
    {
      ...
      description:
        "Tevfik Paşa Hamamı'nın hemen yanında, Osmanlı döneminde bulunduğu mahalleye ismini vermiş Hasan Hoca Camisi burası. Kitabesinde 1831 yılında inşa edildiği, 1974 yılında tamir ettirildiği yazılı. Ne yazık ki bu cami bir hata eseri olarak, İkiçeşmelik'te günümüzde faal olmayan Hacı Hasan Mescidi ile karıştırılmış. Halbuki Hasan Hoca çok daha erken dönemlere ait bir cami.",
    ...
    },
    {
      ...
      description:
        "Kestanepazarı Camii, İzmir'in Konak ilçesinde bulunan 1078, 1667-68 yılında inşası tamamlanmış cami.",
    ...
    },
    {
      ...
      name: "Kadıoğlu Hanı",
      description:
        "İzmir Hoca Hasan Mahallesinde, 1327. Sokakta bulunan bu hanın kuzeybatısında Büyük Vezir Hanı, güneydoğusunda da Karaosmanoğlu Hanı ile Büyük Kuzuoğlu Hanı bulunuyordu. Hanın kitabesi günümüze gelemediğinden yapım tarihi kesinlik kazanamamıştır. Yapı üslubundan ve diğer hanlarla benzerliklerinden ötürü XIX. yüzyılda yapıldığı sanılmaktadır. Aydın Vilayet Salnamesinde (1890–1891) de ismi geçmektedir.",
    ...
    },
    {
      ...
      name: "Caravan Bridge",
      description:
        "Kervan Köprüsü ya da Kemer Köprüsü, MÖ 850 yıllarında Meles Çayı üzerinde inşa edilmiş dünyanın en eski köprüsüdür ve dünyada henüz ayakta olan en eski insan yapımı yapılardan biridir. Homeros'un eserlerinde adı geçen köprü, yüzlerce yıl Anadolu'nun her köşesinden gelen deve kervanlarının geçmesi için kullanılmıştır.",
    ...
    },
    {
      ...
      description:
        "Kabasoğan Mescidi, 19. yüzyılda Kabasoğan ailesi tarafından küçük bir mahalle mescidi olarak inşa edilmiş.Düz ahşap tavanlı mescidin güney duvarı üzerinde sembolik bir minaresi buluyor. Ahşap malzemeli minberi, mihrabın sağında yerini almış. Harim duvarlarının üst sevilerinde yer alan dairesel panolarda halife ve sahabe adlarına yer verilmiş. Harimin ana bölümüne açılan, taş söveleri boya katmanları nedeniyle neredeyse algılanamayacak duruma gelmiş yuvarlak kemerli iki penceresi bulunuyor.Mescit, bir dönem depo ve ticarethane olarak kullanılmışsa da günümüzde yeniden ibadete açılmış durumda.",
      establishment_date: 1801
    },
    {
    ...
    },
    {
      ...
      description:
        "Kültürpark Sanat Galerisi Kültür ve Turizm Bakanlığı İzmir Resim Heykel Müze'sine bağlı bir birim olarak İzmir'in kültür ve sanat hayatında tekrardan yerini aldı. Kültürpark Sanat Galerisi;plastik sanatlar alanında, bu yolla plastik sanatları tanıtarak ülke kültürüne katkıda bulunmak, kendi alanı ile ilgili bilimsel çalışmalar ve eğitim faaliyetlerini düzenlemek amacıyla hizmet vermektedir.",
